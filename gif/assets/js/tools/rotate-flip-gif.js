// Tool logic for Rotate & Flip GIF (rotate-flip-gif)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('rotate_flip' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('rotate_flip' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('rotate_flip' === 'text_on_gif') {

// Tool logic for GIF to WebP Converter (gif-to-webp)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('gif_to_webp' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('gif_to_webp' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('gif_to_webp' === 'text_on_gif') {

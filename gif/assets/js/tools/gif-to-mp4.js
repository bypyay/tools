// Tool logic for GIF to MP4 Converter (gif-to-mp4)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('gif_to_mp4' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('gif_to_mp4' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('gif_to_mp4' === 'text_on_gif') {

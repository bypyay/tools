// Tool logic for Video to GIF Converter (video-to-gif)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('video_to_gif' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('video_to_gif' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('video_to_gif' === 'text_on_gif') {

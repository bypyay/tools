// Tool logic for GIF Compressor (gif-compressor)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('compressor' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('compressor' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('compressor' === 'text_on_gif') {

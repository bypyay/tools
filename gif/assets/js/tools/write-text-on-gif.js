// Tool logic for Add Text to GIF (Meme Maker) (write-text-on-gif)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('text_on_gif' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('text_on_gif' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('text_on_gif' === 'text_on_gif') {

// Tool logic for Split GIF (Frame Extractor) (split-gif-frames)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('split_frames' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('split_frames' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('split_frames' === 'text_on_gif') {

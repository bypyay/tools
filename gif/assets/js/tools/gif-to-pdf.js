// Tool logic for GIF to PDF Contact Sheet (gif-to-pdf)
(function() {
  ...
  processBtn.addEventListener('click', function() {
    ...
    } else if ('gif_to_pdf' === 'video_to_gif') {
      var vUrl = URL.createObjectURL(firstFile);
    ...
    } else if ('gif_to_pdf' === 'split_frames') {
      var reader = new FileReader();
      reader.onload = function(ev) {
        GifCore.decodeGif(ev.target.result).then(function(decoded) {
          var zip = new JSZip();
    ...
    } else if ('gif_to_pdf' === 'text_on_gif') {

// Tool logic for Anniversary Photo Collage (anniversary-photo-collage)
(function() {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function() {
      ...
      CollageCore.downloadFile(dataUrl, 'anniversary-photo-collage-collage.png');
    });
  }
})();

// Tool logic for 2 Photos in One Frame (combine-2-photos-in-one-frame)
(function() {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function() {
      ...
      CollageCore.downloadFile(dataUrl, 'combine-2-photos-in-one-frame-collage.png');
    });
  }
})();

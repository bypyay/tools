// Tool logic for Birthday Collage Maker (birthday-collage-maker)
(function() {
  ...
  if (exportBtn) {
    exportBtn.addEventListener('click', function() {
      ...
      CollageCore.downloadFile(dataUrl, 'birthday-collage-maker-collage.png');
    });
  }
})();
